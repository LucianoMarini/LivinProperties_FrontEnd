...
export default function EditPropertyPage() {
  ...
  useEffect(() => {
    ...
    if (user?.role !== "Administrator" && property.agentId !== user?.id) {
      router.push("/dashboard/properties")
    }
  ...
  if (!property || (user?.role !== "Administrator" && property.agentId !== user?.id)) {
    return null
  }
  ...
  return (
    <div className="space-y-6 max-w-3xl">
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-3xl font-bold text-balance">Edit Property</h1>
